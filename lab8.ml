...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let out = new_id () in
    evt := {id = out; action = listener} :: !evt; out
...
(* .. *)
let fn = WEvent.add_listener newswire fakeNewsNetwork ;;
...
(* .. *)
WEvent.remove_listener newswire fn ;;
...
let receive_report = fun s ->
  ignore (WEvent.add_listener publish (fun () -> (fakeNewsNetwork s; buzzFake s; ()))) ;;
